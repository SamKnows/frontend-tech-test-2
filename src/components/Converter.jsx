...
class Converter extends Component {
  ...
  _showConverted = () => {
    ...
    if(shouldShowConvertedAmount){
      ...
      return (
        <span>{`${base} ${amount} = ${target} ${amountConverted}`}</span>
      );
    }else {
      return (<span></span>);
    }
    ...
    return (
      <article>
        <form onSubmit={this._handleSubmit}>
          <CurrencySelector classSelector={'base-currency'} idSelector={'base'} listChoices={listObjectCurrency} actions={actions}/>
          <CurrencySelector classSelector={'target-currency'} idSelector={'target'} listChoices={listObjectCurrency} actions={actions}/>
